            ...
            <div class="form-card">
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="epwnumia_1" type="text" class="form-control" id="epwnumia_1" data-error="Υποχρεωτικό πεδίο" required>
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="ame_1" type="text" class="form-control" id="ame_1" data-error="Το Α.M.E. δεν είναι έγκυρο" pattern="^[0-9]{10}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="afm_1" type="text" class="form-control" id="afm_1" data-error="Το Α.Φ.Μ. δεν είναι έγκυρο" pattern="^[0-9]{9}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
            ...
            <div class="form-card">
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="address_2" type="text" class="form-control" id="address_2" data-error="Υποχρεωτικό πεδίο" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="tk_2" type="text" class="form-control" id="tk_2" data-error="O Τ.Κ. δεν είναι έγκυρος" pattern="^[0-9]{5}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="dhmos_2" type="text" class="form-control" id="dhmos_2" data-error="Υποχρεωτικό πεδίο (μόνο γράμματα)" pattern="^[A-Za-zΑ-Ωα-ωΆΈΉΊΎΌΏάέήίύόώϊϋΐ]*$" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="phoneNumber_2" type="text" class="form-control" id="phoneNumber_2" data-error="Παρακαλώ δώστε ένα έγκυρο τηλέφωνο" pattern="^[0-9]{10}"  required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
        ...
        <fieldset id="fieldset3">
            <div class="form-card">
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        <label for="AFM" class="form-control-label">Α.Φ.Μ. *</label>
                        <input name="afm_3" type="text" class="form-control" id="afm_3" data-error="Το Α.Φ.Μ. δεν είναι έγκυρο" pattern="^[0-9]{9}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                        <div class="fas fa-question-circle" title="Αριθμός Φορολογικού Μητρώου: 9 ψηφία"> </div> 
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="tk_3" type="text" class="form-control" id="tk_3" data-error="O Τ.Κ. δεν είναι έγκυρος" pattern="^[0-9]{5}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                        <div class="fas fa-question-circle" title="Ταχυδρομικός Κωδικός: 5 ψηφία"> </div> 
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="dhmos_3" type="text" class="form-control" id="dhmos_3" data-error="Υποχρεωτικό πεδίο (μόνο γράμματα)" pattern="^[A-Za-zΑ-Ωα-ωΆΈΉΊΎΌΏάέήίύόώϊϋΐ]*$" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="phoneNumber_3r" type="text" class="form-control" id="phoneNumber_3" data-error="Παρακαλώ δώστε ένα έγκυρο τηλέφωνο" pattern="^[0-9]{10}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                        <div class="fas fa-question-circle" title="10 ψήφιος αριθμός"> </div> 
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="email_3" type="email" class="form-control" id="email_3" data-error="Παρακαλώ δώστε ένα έγκυρο e-mail" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                        <div class="fas fa-question-circle" title="Π.χ. name@example.gr"> </div> 
        ...
        <fieldset id="fieldset4">
            <div class="form-card">
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        <label for="AFM" class="form-control-label">Α.Φ.Μ. *</label>
                        <input name="afm_4" type="text" class="form-control" id="afm_4" data-error="Το Α.Φ.Μ. δεν είναι έγκυρο" pattern="^[0-9]{9}" required>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div style="display: table-cell;padding-left: 20px"><br><p></p>
                        <div class="fas fa-question-circle" title="Αριθμός Φορολογικού Μητρώου: 9 ψηφία"> </div> 
                ...
                <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        ...
                        <input name="birthDate_4" type="date" class="form-control" id="birthDate_4" data-error="Υποχρεωτικό πεδίο" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div><br>
                <!-- Oikog. katastash -->
            ...
            <div class="form-group" style="display: table-row;">
                    <div style="display: table-cell;overflow: auto;">
                        <label for="topos_ergasias" class="form-control-label">Διεύθυνση Κατοικίας Μισθωτού *</label>
    ...
    $(document).ready(function(){
        ...
        $(".next").click(function(){
            ...
            // If this is the fourth fieldset
                ...
                var formObj5 = document.getElementById('lastName_');
