...
<!-- Navbar -->
<nav class="navbar navbar-expand-sm bg-info navbar-light fixed-top" style="height: 110px;">
<!-- Logo -->
<div class="col">
...
<div class="col">
	<ul class="navbar-nav" style="position: relative; margin-left: -3%; margin-top: 8%;">
		<li class="nav-item dropdown">
	    	<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">ΕΡΓΑΖΟΜΕΝΟΙ</a>
   		...
   		<li class="nav-item dropdown">
	    	<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">&nbsp;&nbsp;ΕΡΓΟΔΟΤΕΣ</a>
      		<div class="dropdown-menu">
		...
		<li class="nav-item dropdown">
	    	<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">&nbsp;&nbsp;ΑΝΕΡΓΟΙ</a>
   			<div class="dropdown-menu">
    	...
    	<li class="nav-item dropdown">
		    <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">&nbsp;&nbsp;ΣΥΝΤΑΞΙΟΥΧΟΙ</a>
   			<div class="dropdown-menu">
...
<!-- Other Options -->
<div class="col">
	<ul class="navbar-nav mb-3" style="position: relative; margin-left: -5%;">
		<li class="nav-item">
	...
	<!-- Search form -->
	<div class="row"><div class="col-sm-4"></div><div class="col">
  		<form class="form-inline" action="" style="width: 140%;">
